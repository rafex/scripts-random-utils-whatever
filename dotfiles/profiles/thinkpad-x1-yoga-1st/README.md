...
fijo de 320 píxeles y estado `above`; así i3 y Openbox la mantienen visible
sobre las ventanas de trabajo sin reservar una columna. El panel no roba el
foco, aunque puede cubrir el contenido que quede debajo de su columna.
Incluye kernel,
