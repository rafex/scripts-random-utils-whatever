...
description: Materializa las paletas de terminal, i3, Openbox, tint2, Conky, EWW, tmux, Rofi, Dunst y rxvt-unicode del perfil ThinkPad.
tags:
  - sistema
  - temas
  - referencia
...
`tint2.conf`, `conky.conf` y `eww.scss`. El archivo `i3status.conf` se sincroniza en
...
- **feat:** Añadir Paper, Nord, Everforest y Dracula con soporte para
  rxvt-unicode, i3status, Openbox, tint2, Conky y EWW.
